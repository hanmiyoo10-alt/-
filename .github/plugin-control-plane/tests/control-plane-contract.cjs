...
assert.deepEqual(registry.plugins.local.paths, ['plugins/risu/local/**']);
...
assert.deepEqual(classifyPaths(['plugins/risu/local/README.md'], registry).labels, ['plugin:local']);
