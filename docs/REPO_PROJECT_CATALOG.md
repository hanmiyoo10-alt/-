...
| PLUGIN | O | Local | plugin:usage-dashboard<br>plugin:devpass<br>plugin:voyage-token-check | plugins/usage-dashboard/**<br>products/usage-dashboard/**<br>plugins/devpass/**<br>voyage-token-check/**<br>tools/usage-dashboard-mcp/** | plugins/risu/local | consolidate |
