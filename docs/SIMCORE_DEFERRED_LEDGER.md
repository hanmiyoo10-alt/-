...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 6/52 system designs are currently FROZEN and the scoped next design is SYS-03 Gate Dependency Graph. Frozen SYS application/implementation remains HOLD while that sweep is active.
