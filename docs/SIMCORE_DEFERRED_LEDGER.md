...
System-idea sweep state: 13/52 designs FROZEN; scoped next design = SYS-22 Test Intent Manifest
...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 13/52 system designs are currently FROZEN and the scoped next design is SYS-22 Test Intent Manifest. Frozen SYS application/implementation remains HOLD while that sweep is active.
