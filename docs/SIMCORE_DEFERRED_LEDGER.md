...
System-idea sweep state: 15/52 designs FROZEN; scoped next design = SYS-38 Architecture Contract Diff Reporter
...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 15/52 system designs are currently FROZEN and the scoped next design is SYS-38 Architecture Contract Diff Reporter. Frozen SYS application/implementation remains HOLD while that sweep is active.
