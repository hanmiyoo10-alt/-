...
System-idea sweep state: 25/52 designs FROZEN; scoped next design = SYS-23 Negative-Control Registry
...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 25/52 system designs are currently FROZEN and the scoped next design is SYS-23 Negative-Control Registry. Frozen SYS application/implementation remains HOLD while that sweep is active.
