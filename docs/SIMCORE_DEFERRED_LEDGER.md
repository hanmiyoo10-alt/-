...
System-idea sweep state: 23/52 designs FROZEN; scoped next design = SYS-12 Current-State Snapshot Page
...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 23/52 system designs are currently FROZEN and the scoped next design is SYS-12 Current-State Snapshot Page. Frozen SYS application/implementation remains HOLD while that sweep is active.
