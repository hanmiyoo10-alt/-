...
System-idea sweep state: 19/52 designs FROZEN; scoped next design = SYS-47 User Handoff Card
...
4. Separate system-idea NON_RUNTIME design sweep = ACTIVE; 19/52 system designs are currently FROZEN and the scoped next design is SYS-47 User Handoff Card. Frozen SYS application/implementation remains HOLD while that sweep is active.
