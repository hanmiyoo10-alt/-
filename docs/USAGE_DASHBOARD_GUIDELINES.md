...
- Bridge Engine: `1.6.27`
- Bridge Manager: `1.3.2`
...
Last verified real-device baseline: `3.0.0-alpha.5.87 — Stable Contract Manager Authority Single Source Repair`.
...
Current release implementation: `3.0.0-alpha.5.88 — LLM Gateway CLI 1.14.0 Managed Runtime Upgrade`.
