...
Last verified real-device baseline: `3.0.0-alpha.5.93 — READY on managed @llmgateway/cli 1.10.0`.
...
Current release implementation: `3.0.0-alpha.5.94 — Compact Authoritative 24h Cost Drivers`.
