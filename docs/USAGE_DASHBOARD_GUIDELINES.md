...
Last verified real-device baseline: `3.0.0-alpha.5.92 — READY on managed @llmgateway/cli 1.10.0`.
...
Current release implementation: `3.0.0-alpha.5.93 — Truthful DevPass Cycle / Source-Window Summary`.
