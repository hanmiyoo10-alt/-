...
- Product: `3.0.0-alpha.5.92`
- Bridge Engine: `1.6.29`
...
Last verified real-device baseline: `3.0.0-alpha.5.91 — READY on managed @llmgateway/cli 1.10.0`.
...
Current release implementation: `3.0.0-alpha.5.92 — PAYG + Auto-Reload Read-Only Fidelity`.
