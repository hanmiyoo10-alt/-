...
Last verified real-device baseline: `3.0.0-alpha.5.86 — Managed CLI Engine/Manager Pin Parity Repair`.
...
Current release implementation: `3.0.0-alpha.5.87 — Stable Contract Manager Authority Single Source Repair`.
