...
This does NOT establish record[33] == 0. A valid index selecting an empty slot, unexpected selection state, or corrupted table remains possible. game.cfg alone cannot establish the runtime record layout.
