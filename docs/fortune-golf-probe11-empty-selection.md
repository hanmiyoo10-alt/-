...
Tests cover mapped selection, saved index, irrelevant PC, unmapped/overflow addresses, and register preservation. This is diagnostic, not a gameplay fix. Local Python compilation passed. Actions run 34319538928 passed the combined Rust tests and Clippy step, including the new selection snapshot test. Frontend/APK build was in progress at this checkpoint; device validation remains pending.
