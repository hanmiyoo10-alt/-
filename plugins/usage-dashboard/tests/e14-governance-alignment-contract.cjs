...
console.log('usage-dashboard E14 governance alignment contract: OK · E13 durable transaction generation + E14 candidate DAG baseline · no naming-driven state-machine growth');
