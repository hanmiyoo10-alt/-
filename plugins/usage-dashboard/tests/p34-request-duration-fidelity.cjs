...
console.log(`usage-dashboard P34 Request Duration Fidelity: OK · ${release.productVersion} keeps explicit /logs duration only, UNKNOWN preserved, dedupe identity unchanged, zero/error retained, no extra network call`);
