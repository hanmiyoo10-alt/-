...
assert.equal(hash(enginePath),'48fb53490937d4507662bb42414e0a84b260bb18c6c7e259a12cf42fc8b6d524');
assert.ok(engine.includes("const VERSION = '1.6.2';"));
...
assert.ok(manager.includes("const MANAGER_VERSION = '1.2.4';"));
...
assert.equal(manifest.components.bridgeManager.version,'1.2.4');
