...
assert.ok(manager.includes("const PRODUCT_VERSION = '3.0.0-alpha.5.43';"));
assert.ok(manager.includes("const BUNDLED_ENGINE_VERSION = '1.6.5';"));
assert.equal(manifest.productVersion, '3.0.0-alpha.5.43');
assert.equal(manifest.components.plugin.version, '3.0.0-alpha.5.43');
...
console.log('usage-dashboard P5 per-request service tier fidelity: OK · 3.0.0-alpha.5.43');
