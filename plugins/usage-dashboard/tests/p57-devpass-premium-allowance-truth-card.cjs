...
if (release.productVersion !== '3.0.0-alpha.5.91') {
  console.log(`P57 DevPass Weekly Premium Allowance Truth Card: SKIP · candidate ${release.productVersion} is not 3.0.0-alpha.5.91`);
  process.exit(0);
}
...
// UD_HISTORICAL_VERSION_LOCK — P57 verifies the immutable 5.91 release when that release is current.
...
// UD_HISTORICAL_VERSION_LOCK — Manager Product identity is part of the frozen 5.91 regression.
