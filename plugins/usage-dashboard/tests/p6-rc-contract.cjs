...
assert.ok(source.includes('//@version 3.0.0-alpha.5.46'));
...
assert.equal(manifest.components.plugin.version, '3.0.0-alpha.5.46');
...
assert.equal(manifest.components.bridgeManager.productVersion, '3.0.0-alpha.5.46');
