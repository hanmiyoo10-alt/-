...
assert.ok(source.includes('//@version 3.0.0-alpha.5.47'));
assert.ok(source.includes("const VERSION = '3.0.0-alpha.5.47';"));
...
assert.ok(manager.includes("const PRODUCT_VERSION = '3.0.0-alpha.5.47';"));
assert.equal(manifest.productVersion, '3.0.0-alpha.5.47');
assert.equal(manifest.components.plugin.version, '3.0.0-alpha.5.47');
...
assert.equal(manifest.components.bridgeManager.productVersion, '3.0.0-alpha.5.47');
