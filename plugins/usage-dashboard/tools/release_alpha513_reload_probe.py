...
if f"const PRODUCT_VERSION = '{OLD}';" not in manager:
    raise SystemExit('5.12 manager product anchor missing')
...
print(f'patched {OLD} -> {NEW} reload probe only')
