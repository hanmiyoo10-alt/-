...
replace_once(
    ...
    "      `Stable readiness: ${stableReadiness.ready ? 'READY' : 'BLOCKED'} · updater ${stableReadiness.updaterCompatible ? 'compatible' : 'incompatible'} · blockers ${stableReadiness.blockers.join(', ') || 'none'} · recovered local ${Number(localRuntimeErrors.recoveredCount || 0)}` ,",
