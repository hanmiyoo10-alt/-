...
- workflow: `PocketRisu helper docs`, run `32641765592`, job `97199830398`
- result: `FAILURE`
- cause: `CONFIRMED`
- confirmed log facts:
...
- re-validation: pending on the follow-up commit after the canonical headings were restored.
