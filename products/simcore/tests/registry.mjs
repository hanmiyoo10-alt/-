export const registry = Object.freeze([
  ...
  { id: 'reload-cache-continuity', module: './suites/reload-cache-continuity-v06411.test.mjs', fixtureDir: 'reload-cache-continuity', coverage: 'EXECUTABLE', required: true, goldenGate: true },
