export const registry = Object.freeze([
  ...
  { id: 'validation-v07011-bounded-inherited-bridge', module: './suites/validation-v07011-bounded-inherited-bridge.test.mjs', fixtureDir: 'bounded-telemetry-capsule', coverage: 'EXECUTABLE', required: true, goldenGate: true },
