export const registry = Object.freeze([
  ...
  { id: 'operator-release-card', module: './suites/operator-release-card-v06411.test.mjs', fixtureDir: 'operator-release-card', coverage: 'EXECUTABLE', required: true, goldenGate: true },
  { id: 'host-local-telemetry', module: './suites/host-local-telemetry-v06411.test.mjs', fixtureDir: 'host-local-telemetry', coverage: 'EXECUTABLE', required: true, goldenGate: true },
