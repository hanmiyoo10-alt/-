export const registry = Object.freeze([
  ...
  { id: 'bounded-telemetry-capsule', module: './suites/bounded-telemetry-capsule-v06411.test.mjs', fixtureDir: 'bounded-telemetry-capsule', coverage: 'EXECUTABLE', required: true, goldenGate: true },
