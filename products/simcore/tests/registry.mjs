export const registry = Object.freeze([
  ...
  { id: 'operator-release-card', module: './suites/operator-release-card.test.mjs', fixtureDir: 'operator-release-card', coverage: 'EXECUTABLE', required: true, goldenGate: true },
