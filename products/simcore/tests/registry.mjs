export const registry = Object.freeze([
  ...
  { id: 'reload-cache-continuity', module: './suites/reload-cache-continuity-v06800.test.mjs', fixtureDir: 'reload-cache-continuity', coverage: 'EXECUTABLE', required: true, goldenGate: true },
  { id: 'operator-release-card', module: './suites/operator-release-card-v06800.test.mjs', fixtureDir: 'operator-release-card', coverage: 'EXECUTABLE', required: true, goldenGate: true },
  { id: 'host-local-telemetry', module: './suites/host-local-telemetry-v06800.test.mjs', fixtureDir: 'host-local-telemetry', coverage: 'EXECUTABLE', required: true, goldenGate: true },
  { id: 'bounded-telemetry-capsule', module: './suites/bounded-telemetry-capsule-v06800.test.mjs', fixtureDir: 'bounded-telemetry-capsule', coverage: 'EXECUTABLE', required: true, goldenGate: true },
