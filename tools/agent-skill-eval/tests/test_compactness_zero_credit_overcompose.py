...
prepare_local = load_module("compactness_overcompose_prepare", "prepare_local_eval.py")
context_builder = load_module("compactness_overcompose_context", "build_local_context.py")
...
class CompactnessZeroCreditOvercomposeTests(unittest.TestCase):
    ...
    def test_multiple_independent_goals_uses_deterministic_empty_context(self):
