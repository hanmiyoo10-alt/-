...
class O4EScoutCellError(ValueError):
    pass
...
def execute_cell(
    *,
    ...
    if profile_id not in O4C_MODEL_PROFILE_IDS:
        raise O4EScoutCellError("model profile is outside frozen O4-E matrix")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Run one O4-E Scout schema-hardening diagnostic cell."
    )
    ...
    try:
        ...
        print("O4E_CELL_STATUS:" + result["execution_status"])
        print("O4E_CELL_MODEL:" + result["model"]["profile_id"])
        print("O4E_CELL_RESULT_SHA256:" + result["result_sha256"])
        print("O4E_CELL_SCORE_SHA256:" + score["score_sha256"])
        print("O4E_CELL_RESPONSE_SCHEMA_SHA256:" + metadata["response_schema_sha256"])
        print("O4E_CELL_REQUEST_TIMEOUT_SECONDS:1800")
        return 0
