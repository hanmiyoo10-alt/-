...
class SummaryTests(unittest.TestCase):
    ...
    def test_05_registry_has_ten(self): self.assertEqual(len(WORKFLOWS), 10)
    def test_05b_repository_read_mcp_resolution(self): self.assertEqual(resolve_workflow("repository-read-mcp"), WORKFLOWS[-1])
